...
use szip_migrant_core::{MigrationClaim, PermitType, RegionCode, Status};
use szip_migrant_crypto::StatusProver;
...
fn main() -> Result<()> {
    ...
    match &cli.command {
        ...
        Commands::Verify { file } => {
            ...
            let proof: szip_migrant_crypto::StatusProof = serde_json::from_str(&data)?;
