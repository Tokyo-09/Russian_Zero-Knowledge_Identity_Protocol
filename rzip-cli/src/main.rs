...
use rzip_core::{Claim, Credential, Did};
use rzip_crypto::{AgeProof, AgeProver};
use rzip_verifiable::VerifiableCredential;
use std::fs;
    ...
    match &cli.command {
        ...
        Commands::ProveAge {
            ...
            let _vc = VerifiableCredential {
                credential,
                proof: rzip_verifiable::ProofType::AgeProof(proof.clone()),
            };
        ...
        Commands::Verify { file } => {
            ...
            let vc = VerifiableCredential {
                ...
                proof: rzip_verifiable::ProofType::AgeProof(output.proof),
            };
